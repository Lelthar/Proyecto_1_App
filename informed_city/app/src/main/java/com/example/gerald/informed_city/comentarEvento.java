...
public class comentarEvento extends AppCompatActivity {
  private int id;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    textViewEvento = findViewById(R.id.textViewEvento);
    editTextComentario = findViewById(R.id.editComentario);
    buttonComentar = findViewById(R.id.buttonCrearComentario);
  ...
  private void guardarComentario() throws JSONException {
      ...
      if(!comentario.isEmpty()){
          ...
          //
          try {
              result = conexion.execute("https://informedcityapp.herokuapp.com/commentary_events","POST",jsonParam.toString()).get();
          } catch (InterruptedException e) {
              Toast.makeText(this,e.toString(),Toast.LENGTH_SHORT).show();
          } catch (ExecutionException e) {
              Toast.makeText(this,e.toString(),Toast.LENGTH_SHORT).show();
