...
public class MapsFuturoActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        try{
            if(arg0 != null){
                ...
                if(num!=-1){
                    ...
                    Intent intent1 = new Intent(MapsFuturoActivity.this, DatosEventoFuturo.class);
    ...
    public class DownLoadTask extends AsyncTask<String, Void, String> {
        protected String doInBackground(String... strings) {
            ...
            URL url = null;
            try {
                url = new URL("https://informedcityapp.herokuapp.com/event_futures.json");
